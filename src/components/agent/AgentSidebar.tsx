    ...
    <div className="flex flex-col h-full portal-sidebar">
      <div className="p-6 border-b border-[var(--portal-border)]">
        <div className="flex items-center space-x-3">
          <div className="h-10 w-10 rounded-xl bg-[var(--portal-accent)] flex items-center justify-center text-black shadow-lg">
      ...
      <div className="flex justify-around items-center">
        {menuItems.map((item) => (
          <button
            ...
            onClick={item.action}
          >
            <div className={`p-1 rounded-lg ${activeTab === item.id ? 'bg-[var(--portal-accent)]/10' : ''}`}>
              {item.icon}
            </div>
    ...
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 bg-[var(--portal-sidebar-bg)] border-b border-[var(--portal-border)] p-4 z-10">
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-3">
            <div className="h-8 w-8 rounded-lg bg-[var(--portal-accent)] flex items-center justify-center text-black shadow-md">
